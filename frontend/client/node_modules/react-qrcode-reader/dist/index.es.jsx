...
var reactWebcamExports = reactWebcam.exports;
var Webcam = /*@__PURE__*/getDefaultExportFromCjs(reactWebcamExports);

function QrCodeReader(_a) {
    var delay = _a.delay, width = _a.width, height = _a.height, onRead = _a.onRead, action = _a.action, videoConstraints = _a.videoConstraints;
    var webcamRef = require$$0.useRef(null);
    var analyze = require$$0.useCallback(function () {
        var _a, _b;
        if (!webcamRef)
            return;
    ...
    return (jsxRuntimeExports.jsx(Webcam, { audio: false, ref: webcamRef, width: width, height: height, videoConstraints: videoConstraints }));
}
